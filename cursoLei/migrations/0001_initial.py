# Generated by Django 4.0.6 on 2024-04-21 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_cientifica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cursoLei.area_cientifica')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cursoLei.disciplina')),
                ('linguagens', models.ManyToManyField(to='cursoLei.linguagem_programacao', verbose_name='Linguagens de Programação')),
            ],
        ),
        migrations.CreateModel(
            name='Docente',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, verbose_name='Nome')),
                ('disciplina', models.ManyToManyField(to='cursoLei.disciplina', verbose_name='Disciplina/s')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
            fields=[
                ...
                ('disciplinas', models.ManyToManyField(related_name='cursos', to='cursoLei.disciplina', verbose_name='Disciplinas')),
            ],
        ),
    ]
